    ...
    { switch (tree->kind.exp) {
		...
		switch(tree->kind.dec) {
			...
			case VarK:
				...
				break;
			case ArrK:
				fprintf(listing,"Array declaration, name: %s, size:%d, type :",tree->attr.arrayattr.name,tree->attr.arrayattr.size);
				break;
			default:
		...
		switch(tree->kind.param) {
			case SingleParamK:
				...
				break;
			case ArrayParamK:
				fprintf(listing,"Array parameter, name : %s, size : %d , type :",tree->attr.arrayattr.name,tree->attr.arrayattr.size);
				break;
			default:
			...
			case TypenameK:
				switch(tree->type) {
					...
					case Array:
						...
						break;
					default:
						fprintf(listing,"Unknown ExpType kind\n");
						break;
				}
				break;
			default:
