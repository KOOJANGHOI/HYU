...
{
       0,    36,    36,    39,    50,    52,    53,    55,    61,    70,
      74,    79,    79,    90,    91,    96,   107,   109,   114,   121,
     127,   138,   140,   151,   153,   154,   155,   156,   157,   159,
     160,   162,   168,   174,   180,   184,   189,   194,   196,   200,
     200,   208,   214,   216,   220,   224,   228,   232,   236,   241,
     247,   249,   253,   258,   264,   266,   270,   275,   276,   277,
     278,   280,   280,   283,   284,   286,   297,   299,   304
};
#endif
...
static const char *const yytname[] =
{
  ...
  "UNTIL", "READ", "WRITE", "WHILE", "INT", "VOID", "RETURN", "ID", "NUM",
  "ASSIGN", "LE", "LT", "GT", "GE", "EQ", "NE", "PLUS", "MINUS", "TIMES",
  "OVER", "SEMI", "COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE",
  "LCURLY", "RCURLY", "ERROR", "$accept", "program", "dec_list", "dec",
  "var_dec", "type_spec", "func_dec", "@1", "params", "param_list",
  "param", "comp_stmt", "local_dec", "stmt_list", "stmt", "exp_stmt",
  "sel_stmt", "iter_stmt", "ret_stmt", "exp", "var", "@2", "simple_exp",
  "relop", "additive_exp", "addop", "term", "mulop", "factor", "call",
  "@3", "args", "arg_list", "tid", "tnumber", YY_NULLPTR
};
#endif
...
{
      51,   -90,   -90,    17,    51,   -90,   -90,    -9,   -90,   -90,
     -90,   -90,    15,   -90,    11,    19,   -90,     3,    53,    24,
      40,    -9,    42,    43,   -90,   -90,    13,    44,    51,    46,
     -90,   -90,   -90,   -90,    51,   -90,    -9,    -2,    15,    47,
      50,    14,   -90,   -90,    23,   -90,   -90,   -90,   -90,   -90,
     -90,   -90,    48,    57,   -90,    36,    41,   -90,   -90,    16,
      23,    23,   -90,    54,    52,   -90,    23,   -90,   -90,   -90,
     -90,   -90,   -90,   -90,   -90,    23,    23,   -90,   -90,    23,
      49,    55,    56,    58,   -90,   -90,   -90,   -90,    45,    41,
     -90,    23,    23,     7,     7,    59,   -90,    60,    61,    70,
     -90,   -90,   -90,    23,     7,   -90,   -90
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      21,    12,    15,    18,    23,    20,     0,     0,     0,     0,
       0,     0,    60,    30,     0,    19,    25,    22,    24,    26,
      27,    28,     0,    58,    37,    42,    50,    54,    59,    38,
       0,     0,    34,     0,     0,    29,     0,    43,    44,    45,
      46,    47,    48,    51,    52,     0,     0,    55,    56,     0,
       0,     0,     0,     0,    35,    57,    36,    58,    41,    49,
      53,     0,    64,     0,     0,     0,    66,     0,    63,    32,
      33,    40,    62,     0,     0,    65,    31
};
...
{
     -90,   -90,   -90,    80,    62,     6,   -90,   -90,   -90,   -90,
      65,    67,   -90,   -90,   -89,   -90,   -90,   -90,   -90,   -41,
     -68,   -90,   -90,   -90,    20,   -90,    10,   -90,     9,   -90,
     -90,   -90,   -90,    -5,   -90
};
...
{
      63,    39,    12,    64,    99,   100,    11,    87,    87,    40,
      39,    87,    41,    11,    42,   106,    26,     9,    40,    82,
      83,    41,    11,    42,    21,    86,    43,    16,    44,    11,
      42,    38,    30,    45,    21,    43,    19,    44,    11,    42,
      36,    30,    62,    13,    44,    29,   -61,    14,   -39,    18,
      95,    96,    25,    44,    67,    68,    69,    70,    71,    72,
      73,    74,   105,     1,     2,     1,    20,    77,    78,    73,
      74,   -14,    28,    27,    66,   104,    65,    60,    30,    33,
      61,    91,    84,    85,    10,    92,    89,    93,    90,    94,
     103,   102,   101,    32,    31,    88,    35
};

static const yytype_uint8 yycheck[] =
{
      41,     3,     7,    44,    93,    94,    15,    75,    76,    11,
       3,    79,    14,    15,    16,   104,    21,     0,    11,    60,
      61,    14,    15,    16,    18,    66,    28,    16,    30,    15,
      16,    36,    34,    35,    28,    28,    33,    30,    15,    16,
      34,    34,    28,    28,    30,    32,    30,    32,    32,    30,
      91,    92,    28,    30,    18,    19,    20,    21,    22,    23,
      24,    25,   103,    12,    13,    12,    13,    26,    27,    24,
      25,    31,    29,    31,    17,     5,    28,    30,    34,    33,
      30,    32,    28,    31,     4,    30,    76,    31,    79,    31,
      29,    31,    33,    28,    27,    75,    34
};
...
static const yytype_uint8 yystos[] =
{
      ...
      40,    15,    70,    28,    32,    44,    16,    71,    30,    33,
      13,    42,    45,    46,    47,    28,    70,    31,    29,    32,
      34,    48,    47,    33,    49,    41,    42,    50,    70,     3,
      11,    14,    16,    28,    30,    35,    48,    51,    52,    53,
      54,    55,    56,    57,    59,    61,    63,    65,    66,    70,
      30,    30,    28,    56,    56,    28,    17,    18,    19,    20,
      21,    22,    23,    24,    25,    60,    62,    26,    27,    64,
      58,    67,    56,    56,    28,    31,    56,    57,    61,    63,
      65,    32,    30,    31,    31,    56,    56,    68,    69,    51,
      51,    33,    31,    29,     5,    56,    51
};
...
#line 61 "cminus.y" /* yacc.c:1646  */
    {
				...
				(yyval)->lineno=lineno;
				(yyval)->attr.arrayattr.name=savedName;
				(yyval)->attr.arrayattr.size=savedNumber;
				(yyval)->attr.arrayattr.type=(yyvsp[-5])->type;
			}
...
#line 114 "cminus.y" /* yacc.c:1646  */
    {
				(yyval)=(TreeNode *)newParamNode(ArrayParamK);
				(yyval)->child[0]=(yyvsp[-3]);
				(yyval)->attr.arrayattr.name=savedName;
				(yyval)->attr.arrayattr.type=(yyvsp[-3])->type;
			}
...
#line 280 "cminus.y" /* yacc.c:1646  */
    { (yyval)=newStmtNode(CallK); (yyval)->attr.name=savedName; }
