...
public class WorldPanel extends JPanel implements Runnable {
	...
	// Load all the icons
	private final ImageIcon gardenerImage = new ImageIcon(getClass().getResource("icons/gardener.jpg"));
	private final ImageIcon gnatImage = new ImageIcon(getClass().getResource("icons/gnat.jpg"));
	private final ImageIcon grassImage = new ImageIcon(getClass().getResource("icons/grass.png"));
	private final ImageIcon rabbitImage = new ImageIcon(getClass().getResource("icons/rabbit.gif"));
	private final ImageIcon foxImage = new ImageIcon(getClass().getResource("icons/fox.jpg"));
	private final ImageIcon elephantImage = new ImageIcon(getClass().getResource("icons/elephant.jpg"));
	private final ImageIcon elephantbabyImage = new ImageIcon(getClass().getResource("icons/elephantbaby.jpg"));
	private final ImageIcon unknownImage = new ImageIcon(getClass().getResource("icons/unknown.png"));
	...
	public void paintComponent(Graphics g) {
		...
		synchronized (WorldImpl.class) {
			for (Object thing : world.getAllObjects()) {
				...
				} else if (thing instanceof Elephant) {
					elephantImage.paintIcon(this, g, x, y);
				} else if (thing instanceof ElephantBaby) {
					elephantbabyImage.paintIcon(this, g, x, y);
				} else {
	...
	/**
	 * This method steps the world once and then updates the UI. This method can be
	 * safely called from a separate thread.
	 */
	public boolean step() {
