...
public class RabbitAI extends AbstractAI implements AI {
	 ...
	 * {@inheritDoc}
	 * 
	 * {@link Rabbit} do action in the {@link world}.
	 * 
	 * Especially Rabbit do move, eat, breed.
	 * 
	 ...
	 * {@link Grass} in that direction, return {@link EatCommand} toward that
	...
	public Command act(World world, Actor actor) {
		...
		int choose = generator.nextInt(24);
		if (choose < 6) { // move
			for (int i = 0; i < 4; i++) {
				dir = Util.randomDir();
